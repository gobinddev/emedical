...
<div class="col-md-2">			   
<div class="btn-group">
@if(Arr::exists($modules, 'Users-create'))	 
<a href="{{url('admin/'.$current_menu.'/create')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false">Create User</a>
@endif
</div>
</div>
</div>
<ul class="nav nav-tabs" id="myIconTab" role="tablist">
<li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> All Users </a></li>
</ul>
                        <div class="tab-content" id="myIconTabContent">
                            <div class="tab-pane fade active show" id="homeIcon" role="tabpanel" aria-labelledby="home-icon-tab">
                               <div class="table-responsive tableFixHead" id="data-table" style="height: 420px;">
    ...
    <script type="text/javascript">
        $(function () {
            <?php if (Arr::exists($modules, 'Users-changeStatus') || Arr::exists($modules, 'Users-edit') || Arr::exists($modules, 'Users-delete')): ?>
