            ...
            <div class="main-content">              
                ...
                <div class="card text-left">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                            <h3 class="card-title mb-3"> Slider Images </h3>
                            <p> {{$count}} Slider Images </p>           
                        </div>
                        <div class="col-md-2">             
                            <div class="btn-group">
                            @if(true)
                                <a href="{{url('admin/'.$current_menu.'/create')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false"> Create Slider Images </a>
                            @endif
                            </div>
                        </div>
                        </div>
                              ...
                              <div class="card-body" style="position:relative">
                                <ul class="nav nav-tabs" id="myIconTab" role="tablist">
                                    <li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> All Slider Images </a></li>
...
<!--            
    ...
    $(function () {
        <?php if (true): ?>
            var table = $('.data-table').DataTable({
                ...
                ajax: "{{route($route.'slider_images.index')}}",
        ...
        <?php else: ?>
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    // {data: 'show_in_slider', name: 'show_in_slider'},
    ...
    // function takeShowInSliderChangeAction(table_name, id) {
    //     is_checked = $( '#show-in-slider'+id ).is( ":checked" );
    //     if (is_checked) {
    //         show_in_slider = 'yes';
    //     } else {
    //         show_in_slider = 'no';
    //     }
    //     if (table_name != '' && id != '' && show_in_slider != '') {
    //         $.ajaxSetup({
    //             headers: {
    ...
    //         $.ajax({
    //             type: "POST",
    //             url: "{{route($route.'takeShowInSliderChangeAction')}}",
    //             dataType: 'json',
    //             data: {'table_name': table_name, 'id': id, 'show_in_slider': show_in_slider},
