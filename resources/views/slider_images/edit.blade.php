                        ...
                        <div class="card-body">
                           {!! Form::open(array('route'=>[$route.$current_menu.'.update', $encrypt_id], 'method'=>'PUT', 'id'=>$current_menu.'-form', 'enctype'=>'multipart/form-data', 'role'=>'form')) !!}
                            {!! csrf_field() !!}
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 class="card-title mb-3"> Edit Slider Images </h3> 
                                        <!-- @if ($errors->any())
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-6 form-group mb-12">
                                                            ...
                                                            <input class="form-control" id="heading" type="text" placeholder="Enter Heading" name="heading" value="{{ $records->heading }}">
                                                        ...
                                                        <div class="col-6 form-group mb-12">
                                                            ...
                                                            <input class="form-control" id="url" type="text" placeholder="Enter URL" name="url" value="{{ $records->url }}">
                                                            @if($errors->has('url'))
                                                                <div class="error text-danger">
                                                                    {{$errors->first('url')}}
                                                                </div>
                                                        ...
                                                        <div class="col-12 form-group mb-12">
                                                            ...
                                                            <input class="form-control" id="description" type="text" placeholder="Enter description" name="description" value="{{ $records->description }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group mb-12">
                                                            <table>
                                                                <tbody id="tbody">
                                                                    <tr>
                                                                        <img width="100" height="100" src="{{URL::asset('images/slider_images/')}}{{'/'.$records-> slider_image}}" alt="slider_images" />
                                                                  </tr>      
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="col-6 form-group mb-12">
                                                            ...
                                                            <input class="form-control" id="slider_image" type="file" name="slider_image">
