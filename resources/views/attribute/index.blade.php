...
<div class="row">
<div class="col-md-4">
<h4 class="card-title mb-3"> Attribute </h4>
<p> {{$count}} Attribute</p>
</div>
<div class="col-md-8">
...
@if(true)
{{-- @if($count > 0)
    <a href="{{url('admin/attribute-value'.'/create')}}" class="btn btn-danger mr-2" type="button" aria-haspopup="true" aria-expanded="false">Create Attribute Value</a>
@endif --}}
<a href="{{url('admin/'.$current_menu.'/create')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false">Create Attribute</a>
@endif
</div>
@php
$route = 'admin.';
...
<li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> Attribute </a></li>
</ul>
        ...
        $(function () {
            <?php if (true): ?>
                var table = $('.data-table').DataTable({
                    ...
                    ajax: "{{route($route.'attribute.index')}}",
