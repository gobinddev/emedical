...
<div class="col-md-2">			   
<div class="btn-group">
@if(Arr::exists($modules, 'Customers-create'))   
<a href="{{url('admin/users/create?type=customer')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false">Create Customer</a>
@endif
</div>
</div>
</div>
...
<li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> All Customers </a></li>
    ...
    <script type="text/javascript">
        $(function () {
            <?php if (Arr::exists($modules, 'Customers-changeStatus') || Arr::exists($modules, 'Customers-edit') || Arr::exists($modules, 'Customers-delete')): ?>
