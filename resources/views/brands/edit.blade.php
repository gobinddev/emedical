                    ...
                    <div class="card text-left">
                        ...
                        {!! Form::open(array('route'=>[$route.$current_menu.'.update', $encrypt_id], 'method'=>'PUT', 'id'=>$current_menu.'-form', 'enctype'=>'multipart/form-data', 'role'=>'form', 'onSubmit' => 'return checkPassword(this)')) !!}
                            {!! csrf_field() !!}
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 class="card-title mb-3"> EDIT Brand </h3> 
                                        <div class="data-create">
                                            <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-6 form-group mb-4">
                                                            <label for="url"> Name <span style="color: red">*</span> </label>
                                                            <input class="form-control" id="name" type="text" placeholder="Enter Brand Name" name="name" value="{{ $records->name }}">
                                                            @if($errors->has('name'))
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group mb-4">
                                                                ...
                                                                <input class="form-control" id="logo" type="file" placeholder="Enter Brand Logo" name="logo" value="{{ old('logo') }}">
                                                                @if($errors->has('logo'))
                                                                    <div class="error text-danger">
                                                                        {{$errors->first('logo')}}
                                                                    </div>
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <table>
                                                                <tbody id="tbody">
                                                                    <tr>
                                                                        <img width="200" height="100" src="{{URL::asset('uploads/brands/')}}{{'/'.$records-> logo}}" alt="logo" />
                                                                    <td>
