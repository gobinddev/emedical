                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            ...
                            {!! csrf_field() !!}
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 class="card-title mb-3"> Create Brand </h3> 
                                        <div class="data-create">
                                            <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-6 form-group mb-4">
                                                            <label for="url"> Name <span style="color: red">*</span> </label>
                                                            <input class="form-control" id="name" type="text" placeholder="Enter Brand Name" name="name" value="{{ old('name') }}">
                                                            @if($errors->has('name'))
                                                        ...
                                                        <div class="col-md-6 form-group mb-4">
                                                            <label for="url"> Logo <span style="color: red">*</span> </label>
