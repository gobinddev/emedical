...
<div class="row">
<div class="col-md-10">
<h4 class="card-title mb-3"> Blog Category </h4> 
<p> {{$count}} Blog Category</p>			
</div>
<div class="col-md-2">			   
<div class="btn-group">
@if(true)   
<a href="{{url('admin/'.$current_menu.'/create')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false">Create Blog Category</a>
@endif
</div>
@php
$route = 'admin.';
...
<li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> Blog Category</a></li>
</ul>
        ...
        $(function () {
            <?php if (true): ?>
                var table = $('.data-table').DataTable({
                    ...
                    ajax: "{{route($route.'blog-category.index')}}",
