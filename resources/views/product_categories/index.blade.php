...
<div class="row">
<div class="col-md-10">
<h4 class="card-title mb-3"> Product Categories </h4> 
<p> {{$count}} Product Categories </p>			
</div>
<div class="col-md-2">			   
<div class="btn-group">
@if(Arr::exists($modules, 'Product-categories-create'))   
<a href="{{url('admin/'.$current_menu.'/create')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false">Create Product Category</a>
@endif
</div>
</div>
</div>
<ul class="nav nav-tabs" id="myIconTab" role="tablist">
<li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> All Product Categories </a></li>
</ul>
    ...
    <script type="text/javascript">
        $(function () {
            <?php if (Arr::exists($modules, 'Product-categories-changeStatus') || Arr::exists($modules, 'Product-categories-edit') || Arr::exists($modules, 'Product-categories-delete')): ?>
                var table = $('.data-table').DataTable({
                    ...
                    ajax: "{{route($route.'product_categories.index')}}",
