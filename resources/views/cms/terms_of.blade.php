            ...
            <div class="main-content">				
                ...
                <div class="row">
                    <div class="card text-left">
                        <form action="{{url('admin/terms_of_update')}}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 class="card-title mb-3">Terms of Use </h3> 
                                        
                                          <textarea class="summernote" name="terms_of">{{$data->terms_of}}</textarea>
