			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="breadcrumb-list">
						...
						<li class="breadcrumb-list__item breadcrumb-list__item--active"> Dashboard</li>
					</ul>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="myaccount-tab-menu nav" role="tablist">
                ...
                <a href="{{route('customer.logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> Logout</a>
              ...
              <div class="tab-content" id="myaccountContent">
                ...
                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                  <div class="myaccount-content">
                    <h3>Dashboard</h3>
                    <div class="welcome">
                      <p>Hello, <strong>{{Auth::guard('customer')->user()->display_name}}</strong> (If Not <strong>{{Auth::guard('customer')->user()->last_name}} !</strong> <a href="{{route('customer.logout')}}" class="logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> Logout</a>)</p>
                      <form id="logout-form" action="{{ route('customer.logout') }}" method="POST"
                                  style="display: none;">{{ csrf_field() }}
                        </form>
                    </div>
                          ...
                          @if(count($orders)>0)
                            ...
                            @foreach($orders as $key => $order)
                              ...
                              <tr>
                                ...
                                <td><a href="{{route('customer.order-detail',['id'=>Crypt::encryptString($order->id)])}}" class="check-btn sqr-btn ">View</a></td>
                              </tr>
                            @endforeach
                          @else
                            <tr>
                ...
                <div class="tab-pane fade" id="account-info" role="tabpanel">
                  <div class="myaccount-content">
                    ...
                    <div class="account-details-form">
                      <form method="post" action="{{route('customer.accountupdate')}}" id="accountfrm">
                        @csrf
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="single-input-item">
                              <label for="first-name" class="required">First Name</label>
                              <input type="text" id="first-name" name="first_name" value="{{Auth::guard('customer')->user()->first_name}}"/>
                          ...
                          <div class="col-lg-6">
                            <div class="single-input-item">
                              ...
                              <input type="text" id="last-name" name="last_name" value="{{Auth::guard('customer')->user()->last_name}}"/>
                        ...
                        <div class="single-input-item">
                          ...
                          <input type="text" id="display-name" name="display_name" value="{{Auth::guard('customer')->user()->display_name}}"/ readonly>
                        </div>
                        <div class="single-input-item">
                          <label for="email" class="required">Email Address</label>
                          <input type="email" id="email" name="email" value="{{Auth::guard('customer')->user()->email}}" readonly/>
                        </div>
                        {{--<fieldset>
                ...
                <div class="tab-pane fade" id="change-password" role="tabpanel">
                  <div class="myaccount-content">
                    ...
                    <div class="account-details-form">
                      <form method="post" action="{{route('customer.changepassword')}}" id="changepassfrm">
                        @csrf
                        <div class="row">
                          <div class="col-6">
                            <div class="single-input-item">
  ...
  <div class="modal" id="bill_add_addr">
    <div class="modal-dialog modal-lg">
       <div class="modal-content">
          ...
          <!-- Modal body -->
          <form method="post" action="{{route('customer.billingAddress.create')}}" id="bill_add_frm">
          @csrf
  ...
  <div class="modal" id="bill_edit_addr">
    <div class="modal-dialog modal-lg">
       <div class="modal-content">
          ...
          <!-- Modal body -->
          <form method="post" action="{{route('customer.billingAddress.edit')}}" id="bill_edit_frm">
          @csrf
...
<script>
  $(document).ready(function(){
    ...
    $('.editAddr').click(function(){
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('customer.billingAddress.edit') }}",
                data: {'id':id},
