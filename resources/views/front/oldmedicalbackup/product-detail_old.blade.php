							...
							<div class="col-lg-6 mb-md-70 mb-sm-70">
								...
								<div class="shop-product__big-image-gallery-wrapper mb-30">
									...
									<div class="shop-product__big-image-gallery-slider">
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-1.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-2.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-3.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-4.jpg')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-5.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/trendcoat-1.jpg')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/trendcoat-2.jpg')}}" class="img-fluid" alt="">
										</div>
								...
								<div class="shop-product__small-image-gallery-wrapper">
									...
									<div class="shop-product__small-image-gallery-slider">
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-1-100x100.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-2-100x100.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-3-100x100.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-4-100x100.jpg')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/soccer-5-100x100.png')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/trendcoat-1-100x100.jpg')}}" class="img-fluid" alt="">
										</div>
										...
										<div class="single-image">
											<img src="{{asset('assets/images/shop-product/trendcoat-2-100x100.jpg')}}" class="img-fluid" alt="">
										</div>
							...
							<div class="col-lg-6">
								...
								<div class="shop-product__description">
									...
									<div class="shop-product__brands mb-20">
										...
										<a href="#">
											<img src="{{asset('assets/images/brands/brand-1.png')}}" class="img-fluid" alt="">
										</a>

										<a href="#">
											<img src="{{asset('assets/images/brands/brand-2.png')}}" class="img-fluid" alt="">
										</a>
