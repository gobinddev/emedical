...
<div class="row">
<div class="col-md-10">
<h4 class="card-title mb-3"> Executives </h4> 
<p> {{$count}} Executives </p>			
</div>
<div class="col-md-2">			   
<div class="btn-group">
@if(Arr::exists($modules, 'Executives-create'))   
<a href="{{url('users/create?type=executive')}}" class="btn btn-danger" type="button" aria-haspopup="true" aria-expanded="false">Create Executive</a>
@endif
</div>
</div>
</div>
<ul class="nav nav-tabs" id="myIconTab" role="tablist">
<li class="nav-item"><a class="nav-link active show" id="home-icon-tab" data-toggle="tab" href="#homeIcon" role="tab" aria-controls="homeIcon" aria-selected="true"><i class="nav-icon i-Pen-2 mr-1"></i> All Executives </a></li>                                
</ul>
                                    ...
                                    <table class="table table-bordered data-table">
                                        <thead>
                                            <tr>
                                                ...
                                                @if(Arr::exists($modules, 'Executives-changeStatus') || Arr::exists($modules, 'Executives-edit') || Arr::exists($modules, 'Executives-delete'))
    ...
    <script type="text/javascript">
        $(function () {
            <?php if (Arr::exists($modules, 'Executives-changeStatus') || Arr::exists($modules, 'Executives-edit') || Arr::exists($modules, 'Executives-delete')): ?>
